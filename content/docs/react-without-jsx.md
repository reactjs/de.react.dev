...
Die Komponente kann der Funktion entweder als String, als Unterklasse von `React.Component` oder als zustandslose (englisch: stateless) Komponente in Form einer einfachen Funktion zur Verfügung gestellt werden.
