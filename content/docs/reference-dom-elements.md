...
Ab React 16 werden alle standardmäßigen oder [oder custom](/blog/2017/09/08/dom-attributes-in-react-16.html) DOM-Attribute vollständig unterstützt.

React hat schon immer eine auf JavaScript ausgerichtete API zu dem DOM zur Verfügung gestellt. Da React-Komponenten oft eigene und dem DOM zugehörige Props brauchen, verwendet React die `camelCase` Konvention wie auch die DOM-APIs:
...
Diese Props funktionieren ähnlich wie die entsprechenden HTML-Attribute mit Ausnahme von den untenstehenden Spezialfällen.

Einige von den DOM-Attributen, die von React unterstützt werden:
...
Alle SVG-Attribute, die von React vollständig unterstützt werden:
...
Du kannst auch eigene Attribute verwenden, sofern diese kleingeschrieben werden.
